...
*------------------------------------------------------------------------------- 	
	...
	lab var read 		"Any member can read or write"
	lab var sick 		"Any member was sick in the last 4 weeks"
	lab var days_sick 		"Average number of sick days"
	lab var treat_cost_usd 		"Total cost of medical treatment in USD"
...
*------------------------------------------------------------------------------- 	
	...
	egen n_medfacilities = rowtotal(n_clinic n_hospital), missing
	lab var n_medfacilities "Number of medical facilities by district"
	...
	// Exercise 6: Save final dataset ----
		// Instructions:
			...
			//Save data
	save "${data}/Final/TZA_amenity_analysis.dta.dta", replace
